...
|---|---:|---|---|---:|
| `PROJECT_DATA_ROOT` | no/yes | Large data outside OneDrive | `/mnt/d/datasets/<project>` | yes |
| `PROJECT_CACHE_ROOT` | no/yes | Cache/intermediate outside OneDrive | `/home/<user>/.cache/<project>` | yes |
| `PROJECT_OUTPUT_ROOT` | no/yes | Heavy outputs outside OneDrive | `/mnt/d/outputs/<project>` | yes |
