...
```bash
/mnt/c/Users/<windows-user>/shared/synced project storage/agent-project-kit/templates/pandoc-thai-a4/build-thai-a4-pdf.sh input.md output.pdf
```
...
```bash
pandoc input.md \
  --defaults="/mnt/c/Users/<windows-user>/shared/synced project storage/agent-project-kit/templates/pandoc-thai-a4/thai-a4-defaults.yaml" \
  --resource-path=".:/mnt/c/Users/<windows-user>/shared/synced project storage/agent-project-kit/templates/pandoc-thai-a4" \
  -o output.pdf
```
