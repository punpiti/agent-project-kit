...
release ปัจจุบัน: `7.9.0-state-migration-canary`
...
Windows PowerShell (ต้องมี Python 3.9 ขึ้นไป ติดตั้ง Python install manager จาก <https://www.python.org/downloads/> ซึ่งมีคำสั่ง `py` มาให้):
