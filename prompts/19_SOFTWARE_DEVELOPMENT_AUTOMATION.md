# 19 — Software Development & Automation

Use for web, API, CLI, desktop, automation, integration, computer-vision,
data-pipeline, and general software work.
...
7. Run focused checks first, then broaden only when risk or failure warrants it.

Load `14_WEB_DEVELOPMENT.md` for browser/UI/accessibility concerns. Load
`03_CODEX_CODING_AGENT.md` only for a substantial implementation/debug loop.
