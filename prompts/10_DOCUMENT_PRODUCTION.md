...
0. ถ้ามี PDF ที่จะใช้อ้างอิง ให้ใช้ PDF-to-text แกะเป็น text/Markdown และเก็บเป็น
   ...
   ทั้งหน้าเป็นภาพแทนการพยายามดึงเฉพาะรูป และห้ามใช้ auto-crop เป็นค่าเริ่มต้น เพราะเคยพบว่า
   ตัด caption หลุดและตัดแผงรูปย่อยในรูปหลายแผงหายไปโดยไม่มี error แจ้งเตือน ใช้ auto-crop
   เฉพาะพรีวิวไว ๆ แล้วต้องตรวจไฟล์ที่ได้ด้วยตาทุกครั้งก่อนใช้จริง
   ถ้าเอกสารมีเลขหน้าสองระบบ (เช่น เลขหน้าพิมพ์กับเลขหน้าไฟล์) ห้ามสมมติว่า offset
   ระหว่างสองระบบคงที่ตลอดทั้งเล่ม ให้ยืนยัน offset ด้วยข้อความที่รู้แน่ชัดในหน้านั้นก่อน
   อ้างอิงเลขหน้าพิมพ์ทุกครั้งที่ขึ้นช่วงหน้า/บทใหม่
